...
<div id="container" class="site">
	...
	<?php $options = get_option( 'tuned_theme_options' ); ?>
	
	<?php if( basename( get_page_template() ) == 'front-page.php' && is_active_sidebar( 'front-page-template-hero' ) ) : ?>		
			<div class="header-box<?php echo '-full' ? $options['full_width_hero'] == 'yes' : ''; ?>"><?php dynamic_sidebar('front-page-template-hero'); // This is the Hero Box ?></div>
	<?php endif; ?>
		
	<?php if( basename( get_page_template() ) == 'front-page.php' && is_active_sidebar( 'front-page-template-carousel' ) ) : ?>		
			<div class="header-box<?php echo '-full' ? $options['full_width_slider'] == 'yes' : ''; ?>"><?php dynamic_sidebar('front-page-template-carousel'); // This is the Carousel Box ?></div>
	<?php endif; ?>
