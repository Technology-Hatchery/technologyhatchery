...
class WPBakeryShortCode_AZ_Progress_Bar extends WPBakeryShortCode {
  protected function content($atts, $content = null) {
    $animation_loading = $animation_loading_effects = $field = $percentage = $bgcolor = $checkicon = $icon = $custombarcolor = $el_class = '';
	  ...
	  $output .= '<div class="progress-bar '.$el_class.' '.$animation_loading_class.' '.$animation_effect_class.'">';
