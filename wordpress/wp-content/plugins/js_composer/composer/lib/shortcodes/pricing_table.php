...
class WPBakeryShortCode_AZ_Pricing_Table extends WPBakeryShortCode {
  protected function content($atts, $content = null) {
    $animation_loading = $animation_loading_effects = $title = $price = $currency = $interval = $link_url = $link_text = $highlight = $target = $el_class = '';
	  ...
	  $output .= '<div class="pricing-table '.$highlight_to.$el_class.' '.$animation_loading_class.' '.$animation_effect_class.'">';
	  $output .= '<h5>'.$title.'</h5>';
